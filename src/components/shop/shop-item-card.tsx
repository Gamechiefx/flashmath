...
export function ShopItemCard({ itemId, isOwned, userCoins }: ShopItemCardProps) {
    ...
    const handleMouseEnter = () => {
        ...
        if (item.type === ItemType.SOUND) {
            // Play a generic click or the pack's "click" sound (if we access it directly? 
            // SoundEngine loads packs. This is tricky.
            // Ideally we play a sample.
            // For now, let's just play a standard click to acknowledge hover?
            // Or if we implemented dynamic loading, we'd load it.
            // Let's rely on BGM/Particle mainly as requested.
        }
    };
